...
MM_GENERATOR_MODEL='diffusers-sd-turbo'
...
MPO_LOG_ROOT="${MPO_LOG_ROOT:-$HOME/mpo_logs}"
LOG_DIR="$MPO_LOG_ROOT/$BASE_MODEL/$OPTIM_MODEL/$MM_GENERATOR_MODEL/${EXP_NAME}/${TASK}"
